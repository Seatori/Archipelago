...
connections: dict[str, RegionConnectionData] = {
    ...
    "Wellspring Cave Stairs": RegionConnectionData("Wellspring Cave Inner", "Wellspring Cave B1F", dark_cave_logic),
    ...
    "Route 6 north east cave entrance": RegionConnectionData("Route 6", "Mistralton Cave Entrance", can_use_surf),  # TODO: Dark cave
    ...
    "Route 9 cave entrance": RegionConnectionData("Route 9", "Challenger's Cave", has_red_chain),  # TODO: Dark cave
